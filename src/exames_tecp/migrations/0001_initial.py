# Generated by Django 2.0.7 on 2020-09-01 22:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VO2_Rest_ml_kg_min', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VO2 (mL/kg/min) - Rest')),
                ('VO2_AT_ml_kg_min', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VO2 (mL/kg/min) - AT')),
                ('VO2_VO2Max_ml_kg_min', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VO2 (mL/kg/min) - VO2 Max')),
                ('VO2_Pred_ml_kg_min', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VO2 (mL/kg/min) - Pred')),
                ...
                ('RER_Rest', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='RER - Rest')),
                ('RER_AT', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='RER - AT')),
                ('RER_VO2Max', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='RER - VO2 Max')),
                ('VE_BTPS_Rest', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VE BTPS (L/min) - Rest')),
                ('VE_BTPS_AT', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VE BTPS (L/min) - AT')),
                ('VE_BTPS_VO2Max', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VE BTPS (L/min) - VO2 Max')),
                ('VE_BTPS_Pred', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='VE BTPS (L/min) - Pred')),
                ('VE_BTPS_VO2MaxPred', models.IntegerField(verbose_name='VE BTPS (L/min) - VO2 Max/Pred (%)')),
                ('Vt_BTPS_Rest', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Vt BTPS (L) - Rest')),
                ('Vt_BTPS_AT', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Vt BTPS (L) - AT')),
                ('Vt_BTPS_VO2Max', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Vt BTPS (L) - VO2 Max')),
                ...
                ('Ti_Ttot_Rest', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Ti/Ttot - Rest')),
                ('Ti_Ttot_AT', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Ti/Ttot - AT')),
                ('Ti_Ttot_VO2Max', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Ti/Ttot - VO2 Max')),
                ('Ti_Rest', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Ti - Rest')),
                ('Ti_AT', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Ti - AT')),
                ('Ti_VO2Max', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Ti - VO2 Max')),
                ('Te_Rest', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Te - Rest')),
                ('Te_AT', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Te - AT')),
                ('Te_VO2Max', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Te - VO2 Max')),
